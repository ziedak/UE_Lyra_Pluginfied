...
class CUSTOMUI_API ULyraTabListWidgetBase : public UCommonTabListWidgetBase
{
	GENERATED_BODY()
...
public:
	...
	DECLARE_EVENT_TwoParams(ULyraTabListWidgetBase, FOnTabContentCreatedNative, FName /* TabId */,
