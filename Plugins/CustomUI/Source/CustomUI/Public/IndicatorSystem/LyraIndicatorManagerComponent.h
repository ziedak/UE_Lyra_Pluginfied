...
class CUSTOMUI_API ULyraIndicatorManagerComponent : public UControllerComponent
{
	GENERATED_BODY()
...
public:
	...
	static ULyraIndicatorManagerComponent* GetComponent(const AController* Controller);
