...
#include "Foundation/LyraConfirmationScreen.h"
...
void ULyraConfirmationScreen::SetupDialog(UCommonGameDialogDescriptor* Descriptor,
                                          FCommonMessagingResultDelegate ResultCallback)
{
	...
	EntryBox_Buttons->Reset<ULyraButtonBase>([](ULyraButtonBase& Button){ Button.OnClicked().Clear(); });
...
void ULyraConfirmationScreen::KillDialog() { Super::KillDialog(); }
...
void ULyraConfirmationScreen::NativeOnInitialized()
{
	...
	Border_TapToCloseZone->OnMouseButtonDownEvent.BindDynamic(
		this, &ULyraConfirmationScreen::HandleTapToCloseZoneMouseButtonDown);
}
...
FEventReply ULyraConfirmationScreen::HandleTapToCloseZoneMouseButtonDown(
