...
#include "Common/LyraListView.h"
#include "Common/LyraWidgetFactory.h"
...
UUserWidget& ULyraListView::OnGenerateEntryWidgetInternal(UObject* Item, TSubclassOf<UUserWidget> DesiredEntryClass,
