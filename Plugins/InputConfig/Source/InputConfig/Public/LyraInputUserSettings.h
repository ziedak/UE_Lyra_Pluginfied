 ...
 */
UCLASS()
class INPUTCONFIG_API ULyraInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class INPUTCONFIG_API ULyraPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
