...
// to determine whether to show a setting
...
public:
	...
	static TSharedRef<FWhenPlatformHasTrait> DisableIfMissing(FGameplayTag InVisibilityTag,
	...
	static TSharedRef<FWhenPlatformHasTrait> DisableIfPresent(FGameplayTag InVisibilityTag,
	                                                          const FText& InDisableReason);
