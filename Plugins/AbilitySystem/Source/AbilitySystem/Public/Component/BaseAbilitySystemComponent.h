...
public:
	...
	void CancelActivationGroupAbilities(EAbilityActivationGroup Group,
	                                    UBaseGameplayAbility* IgnoreAbility,
	                                    bool bReplicateCancelAbility);
	void ToggleDynamicTagGameplayEffect(const TSoftClassPtr<UGameplayEffect>& DynamicTagGameplayEffect, const FGameplayTag& Tag);
