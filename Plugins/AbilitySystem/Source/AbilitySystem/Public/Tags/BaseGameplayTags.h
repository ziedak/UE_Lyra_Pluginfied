...
namespace InputTags
{
	...
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(JUMP);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TEST);
}

namespace BaseGameplayTags
{
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(MOVEMENT_STOPPED);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DAMAGE);
	...
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DAMAGE_MESSAGE);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(ABILITY_INPUT_BLOCKED);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(ELIMINATION_MESSAGE);
}

namespace GameplayCueTags
{
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(CHARACTER_DAMAGE_TAKEN);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(CHARACTER_HEAL);
}

namespace GameplayEffectTags
{
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DAMAGETRAIT_BASIC);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(DAMAGETRAIT_INSTANT);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HEAL);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HEAL_INSTANT);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(HEAL_PERIODIC);
}
...
{
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TRAIT_INPUT_HARDWARECURSOR);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TRAIT_BINAURAL_SETTING_CONTROLLED_BY_OS);
}

namespace UITags
{
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(LAYER_GAME);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(LAYER_GAMEMENU);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(LAYER_MENU);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(LAYER_MODAL);
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(ACTION_ESCAPE);
}

namespace GameViewportPlatformTags
{
	ABILITYSYSTEM_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TRAIT_INPUT_HARDWARECURSOR);
}
