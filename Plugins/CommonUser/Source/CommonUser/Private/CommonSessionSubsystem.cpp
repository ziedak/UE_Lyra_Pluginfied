...
public:
	...
	virtual ~FCommonOnlineSearchSettingsBase() override
	{
	}
...
public:
	...
	virtual ~FCommonSession_OnlineSessionSettings() override
	{
	}
};
...
public:
	...
	virtual ~FCommonOnlineSearchSettingsOSSv1() override
	{
	}
};
#else
