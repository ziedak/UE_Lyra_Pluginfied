...
#include UE_INLINE_GENERATED_CPP_BY_NAME(PlatformEmulationSettings)

#define LOCTEXT_NAMESPACE "Cheats"

#if WITH_EDITOR
void UPlatformEmulationSettings::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
...
void UPlatformEmulationSettings::PostReloadConfig(FProperty* PropertyThatWasLoaded)
{
...
void UPlatformEmulationSettings::PostInitProperties()
{
...
void UPlatformEmulationSettings::OnPlayInEditorStarted() const
{
...
void UPlatformEmulationSettings::ApplySettings()
{
...
TArray<FName> UPlatformEmulationSettings::GetKnownPlatformIds() const
{
...
TArray<FName> UPlatformEmulationSettings::GetKnownDeviceProfiles() const
{
	TArray<FName> Results;
...
void UPlatformEmulationSettings::PickReasonableBaseDeviceProfile()
{
