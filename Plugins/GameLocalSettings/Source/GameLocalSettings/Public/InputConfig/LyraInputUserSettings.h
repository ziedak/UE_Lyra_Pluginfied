 ...
 */
UCLASS()
class GAMELOCALSETTINGS_API ULyraInputUserSettings : public UEnhancedInputUserSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class GAMELOCALSETTINGS_API ULyraPlayerMappableKeySettings : public UPlayerMappableKeySettings
{
	GENERATED_BODY()
