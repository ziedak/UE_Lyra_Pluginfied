...
void UGamePlayAbility_Base::EndAbility(const FGameplayAbilitySpecHandle Handle,
...
UHeroComponent* UGamePlayAbility_Base::GetHeroComponentFromActorInfo() const
{
	return (CurrentActorInfo ? UHeroComponent::FindHeroComponent(CurrentActorInfo->AvatarActor.Get()) : nullptr);
}
...
void UGamePlayAbility_Base::SetCameraMode(const TSubclassOf<UCustomCameraMode>& CameraMode)
{
	...
	if (UHeroComponent* HeroComponent = GetHeroComponentFromActorInfo())
	{
